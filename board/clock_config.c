...
outputs:
- {id: ADC0_clock.outFreq, value: 6 MHz}
...
- {id: MRCC.ADC0CLKDIV.scale, value: '16', locked: true}
- {id: MRCC.ADC0CLKSEL.sel, value: SCG.FRO_HF}
...
void BOARD_BootClockFRO12M(void)
{
    ...
    CLOCK_SetClockDiv(kCLOCK_DivADC0, 16U);                /* !< Set ADC0CLKDIV divider to value 16 */
...
- {id: FRO_HF_clock.outFreq, value: 96 MHz}
- {id: LPI2C0_clock.outFreq, value: 96 MHz}
